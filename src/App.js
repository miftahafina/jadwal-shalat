...
function App() {
  ...
  <div className="container h-screen p-4 text-center bg-green-100 mx-auto">
    ...
    <div className="flex flex-row items-center justify-start px-4 bg-green-500 p-3 rounded-full">
      ...
      <DebounceInput minLength="3" debounceTimeout={300} className="bg-green-500 mx-2 px-2 w-full text-base outline-none" name="location" id="location" value={location} onChange={changeLocation} />
    </div>

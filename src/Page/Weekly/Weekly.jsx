  ...
  return (
    <table className="table-fixed w-full mt-8">
      ...
      <tr>
          ...
          <td className="bg-gray-200 border-2 border-gray-100 p-1 text-xs">01.00</td>
          <td className="bg-gray-200 border-2 border-gray-100 p-1 text-xs">02.00</td>
          <td className="bg-gray-200 border-2 border-gray-100 p-1 text-xs">03.00</td>
          <td className="bg-gray-200 border-2 border-gray-100 p-1 text-xs">04.00</td>
          <td className="bg-gray-200 border-2 border-gray-100 p-1 text-xs">05.00</td>
        </tr>
